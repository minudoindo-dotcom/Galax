...
while elapsed < BAR_DURATION do
    ...
    if progress > 0.85 then
        ...
        if foundScript then
            barFill.Color, appIcon.Color = lerpColor(C_ACCENT, C_OK, t), lerpColor(C_ACCENT, C_OK, t)
        else
            barFill.Color, appIcon.Color = lerpColor(C_ACCENT, C_FAIL, t), lerpColor(C_ACCENT, C_FAIL, t)
        end
    end
...
if foundScript then
    statusDraw.Text = "Game Found!"; statusDraw.Color = C_OK
else
    statusDraw.Text = "Game Not Found"; statusDraw.Color = C_FAIL
end

-- 4.5. DRIFT DURANTE RESULT
